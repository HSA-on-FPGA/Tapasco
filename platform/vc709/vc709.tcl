...
namespace eval platform {
  ...
  proc create_pcie_core {} {
    ...
    set pcie_properties [list \
      ...
      CONFIG.pciebar2axibar_0 {0x0002000000000000} \
    ]
  ...
  proc platform_address_map_set {{tapasco_base 0x0}} {
    ...
    foreach dma [lsort [get_bd_cells "/Memory/dual_dma*"]] {
      ...
      create_bd_addr_seg -range 4G -offset 0x0001000000000000 $ms $ts "SEG_$ms"
    }
    ...
    set ts [get_bd_addr_segs /Memory/mig/*]
    foreach u $usrs {
      create_bd_addr_seg -range [get_property RANGE $u] -offset 0x0001000000000000 $u $ts "SEG_$u"
    }
  }

  proc platform_address_map {} {
    platform_address_map_set 0x0002000000000000
