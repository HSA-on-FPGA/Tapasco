...
#define MEMORY_OFFSET 0x0001000000000000
...
{
	fflink_dma[dma_used].from_dev(MEMORY_OFFSET + device_buffer, host_handle, btt, device_base_addr);
}
...
{
	fflink_dma[dma_used].to_dev(MEMORY_OFFSET + device_buffer, host_handle, btt, device_base_addr);
}
